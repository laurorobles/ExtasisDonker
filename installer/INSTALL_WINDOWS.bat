...
setlocal
echo ============================================================
echo  ExtasisDonker - Windows Automated Installer
echo ============================================================
...
if exist "%INSTALL_DIR%ExtasisDonker.vst3" (
    xcopy /E /I /Y /Q "%INSTALL_DIR%ExtasisDonker.vst3" "%VST3_DIR%\ExtasisDonker.vst3"
)
