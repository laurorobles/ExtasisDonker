...
public:
    ...
    ActivationOverlayComponent()
    {
        ...
        licenseInput.setTextToShowWhenEmpty ("EXTD-XXXX-XXXX-XXXX-XXXX", juce::Colour(0xff718093));
    ...
    void paint (juce::Graphics& g) override
    {
        ...
        g.drawText ("EXTASIS DONKER", modalX + 20, modalY + 12, 160, 22, juce::Justification::left);
